  ...
  },
  {
    ...
    capabilities: {
      ...
      feeds: [
        ...
        {
          feedId: "subtitled-episodes",
          title: "With Subtitles",
          description: "Recently added SvetSerialu episodes with subtitles.",
          kind: "new-episodes",
          defaultEnabled: false,
          pageTitle: "SvetSerialu With Subtitles",
          supportsSearch: true,
          supportsOpenSource: true,
          supportsImport: true,
          sortMode: "newest",
        ...
        },
        {
          feedId: "new-series",
          title: "New Series",
          description: "The newest series added to SvetSerialu.",
          kind: "new-additions",
          defaultEnabled: false,
          pageTitle: "SvetSerialu New Series",
          supportsSearch: true,
          supportsOpenSource: true,
          supportsImport: true,
          sortMode: "newest",
