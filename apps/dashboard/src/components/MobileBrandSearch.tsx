  ...
  return (
    <div className="lg:hidden">
      ...
      <div className="mt-4 flex gap-2.5">
        <label className="group flex h-12 min-w-0 flex-1 items-center gap-3 rounded-2xl border border-white/[0.08] bg-white/[0.045] px-4 backdrop-blur-md transition focus-within:border-white/15 focus-within:bg-white/[0.09]">
