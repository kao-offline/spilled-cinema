  ...
  return (
    <div className="lg:hidden">
      ...
      <div className="mt-4 flex gap-2.5">
        <label data-tutorial="search-bar" className="group flex h-12 min-w-0 flex-1 items-center gap-3 rounded-2xl border border-white/[0.08] bg-white/[0.045] px-4 backdrop-blur-md transition focus-within:border-white/15 focus-within:bg-white/[0.09]">
        ...
        <button data-tutorial="homepage-settings" type="button" onClick={onOpenSettings} className="flex h-12 w-12 shrink-0 items-center justify-center rounded-2xl border border-white/[0.08] bg-white/[0.045] text-white/60 backdrop-blur-md transition hover:border-white/15 hover:bg-white/[0.09] hover:text-white active:scale-95" aria-label="Open settings"><Settings2 className="h-5 w-5" /></button>
      </div>
    </div>
  );
}
